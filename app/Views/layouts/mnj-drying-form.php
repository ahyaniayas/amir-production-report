        ...
        <div class="col-sm-12">
          <form action="<?= $postUrl ?>" method="post">
            <div class="form-group mb-3">
              ...
              <input type="text" class="form-control" name="jenis_label" value="<?= !empty($drying[0]['jenis_label'])? $drying[0]['jenis_label']: '' ?>" required/>
            </div>
            <div class="form-group mb-3">
              <input type="hidden" name="id_drying" value="<?= !empty($drying[0]['id_drying'])? $drying[0]['id_drying']: '' ?>"/>
